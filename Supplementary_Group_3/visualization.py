...
# python3 visualization.py --fuel H2 --h2-csv output_null_csv/h2_null_example_2025.csv --years 2025 --out-dir vis_null --radius-km 30 --k-min 3 --r-max-km 50 --log-level INFO
